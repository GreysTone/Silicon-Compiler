...
%token GT_LEXICAL_TOKEN::T_PACKAGE
%token GT_LEXICAL_TOKEN::T_LCB
%token GT_LEXICAL_TOKEN::T_RCB
%token <sval> GT_LEXICAL_TOKEN::T_IDENTIFIER
%token <ival> GT_LEXICAL_TOKEN::T_INTCONSTANT
